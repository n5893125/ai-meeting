...
$source = Get-Location
$dest = "C:\Users\kyhsu\AiMeeting_Fix5"

Write-Host "Preparing FIXED source code (Round 5 - Final) for GitHub upload..." -ForegroundColor Cyan
...
Write-Host "Done! 'AiMeeting_Fix5' folder is ready." -ForegroundColor Green
Write-Host "Please upload content of C:\Users\kyhsu\AiMeeting_Fix5 to GitHub." -ForegroundColor Yellow
Invoke-Item .
